...
A (non-official) command-line interface for [Buffer](https://buffer.com) via the [Buffer API](https://developers.buffer.com) — to manage your social media accounts, channels, and posts from the terminal.
